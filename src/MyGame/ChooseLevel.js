...
ChooseLevel.prototype.update = function () {
    ...
    if(xpos> 12 && xpos<18 && ypos>31.24 && ypos<31.26 && !this.isdead)
    {
        this.mState = 1;
        gEngine.GameLoop.stop();
    }
    if(xpos> 22 && xpos<28 && ypos>31.24 && ypos<31.26 && !this.isdead)
    {
        this.mState = 2;
        gEngine.GameLoop.stop();
    }
    if(xpos> 32 && xpos<38 && ypos>31.24 && ypos<31.26 && !this.isdead)
    {
        this.mState = 3;
        gEngine.GameLoop.stop();
    }
